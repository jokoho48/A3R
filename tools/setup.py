...
def main():
    ...
    print("""
  ######################################
  # A3R Development Environment Setup #
  ######################################

  This script will create your A3R dev environment for you.

  Before you run this, you should already have:
    - A properly setup A3R Development Environment

  If you have not done those things yet, please abort this script in the next step and do so first.

  This script will create two hard links on your system, both pointing to your A3R project folder:
    [Arma 3 installation directory]\\{} => A3R project folder
    P:\\{}                              => A3R project folder
    ...
    if not os.path.exists("P:\\z\\ace"):
        print("No A3R Development Environment detected.")
        return 2
